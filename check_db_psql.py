...
kubectl exec $POD -- sh -c 'PGPASSWORD=secret_password psql -h postgres-service -U picme_user -d picme_db -c "SELECT id, cover_image FROM marketplace_listings ORDER BY id DESC LIMIT 5;"'
"""
