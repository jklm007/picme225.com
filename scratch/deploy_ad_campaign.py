...
FILES_TO_DEPLOY = {
    "app/Http/Controllers/Resource/AdCampaignResource.php": "/var/www/picme/app/Http/Controllers/Resource/AdCampaignResource.php",
    "resources/views/admin/ad-campaign/show.blade.php": "/var/www/picme/resources/views/admin/ad-campaign/show.blade.php",
}
...
def deploy():
    ...
    for local_path, pod_path in FILES_TO_DEPLOY.items():
        ...
        tmp_path = f"/tmp/deploy3_{base_name}"
