...
FILES_TO_DEPLOY = {
    "app/Models/Service.php": "/var/www/picme/app/Models/Service.php",
    "app/Models/ServiceType.php": "/var/www/picme/app/Models/ServiceType.php",
}
...
def deploy():
    ...
    for local_path, pod_path in FILES_TO_DEPLOY.items():
        ...
        tmp_path = f"/tmp/deploy_models_{base_name}"
