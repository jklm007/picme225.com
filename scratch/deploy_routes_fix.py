...
FILES_TO_DEPLOY = {
    "app/Providers/AppServiceProvider.php": "/var/www/picme/app/Providers/AppServiceProvider.php",
    "routes/admin.php": "/var/www/picme/routes/admin.php",
    "app/Http/Controllers/Admin/MarketplaceListingController.php": "/var/www/picme/app/Http/Controllers/Admin/MarketplaceListingController.php",
}
...
def deploy():
    ...
    for local_path, pod_path in FILES_TO_DEPLOY.items():
        ...
        tmp_path = f"/tmp/deploy2_{base_name}"
    ...
    ssh.exec_command(f"kubectl exec {pod} -n {NAMESPACE} -- php artisan route:clear")
