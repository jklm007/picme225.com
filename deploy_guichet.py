...
files_to_deploy = [
    ('resources/views/admin/tickets/sell.blade.php', '/tmp/sell.blade.php'),
    ('resources/views/admin/tickets/sold.blade.php', '/tmp/sold.blade.php'),
    ('app/Http/Controllers/Admin/TicketController.php', '/tmp/TicketController.php'),
]
...
for POD in $ALL_PODS; do
    echo "Copie dans $POD..."
    kubectl cp /tmp/sell.blade.php default/$POD:/app/resources/views/admin/tickets/sell.blade.php
    kubectl cp /tmp/sold.blade.php default/$POD:/app/resources/views/admin/tickets/sold.blade.php
    kubectl cp /tmp/TicketController.php default/$POD:/app/app/Http/Controllers/Admin/TicketController.php
