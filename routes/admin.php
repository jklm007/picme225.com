...
Route::resource('hospital', 'Resource\HospitalResource');
Route::resource('kmhour','Resource\KmHourResource');
Route::post('/kmhour/update/{id}','Resource\KmHourResource@update')->name('kmhour.update');
...
Route::get('setting/payment', 'AdminController@settings_payment')->name('settings.payment');
