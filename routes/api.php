...
Route::get('/package/rental' , 'UserApiController@rental_package');
Route::get('/service/rental' , 'UserApiController@rental_service');
...
Route::group(['middleware' => ['auth:api']], function () {
	...
	Route::post('/hospital_location' , 	'UserApiController@Hospital_based_location');
