    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white p-0 overflow-hidden">
                ...
                <div class="p-4 border-bottom d-flex justify-content-between align-items-center bg-light">
                    <div>
                        <h4 class="mb-0 font-weight-bold">
                            <i class="fa fa-plus-circle text-success mr-2"></i> Ajouter une Compagnie Interurbaine
                        </h4>
                        <span class="text-muted small">Transporteur officiel pour les lignes Outstation</span>
                    </div>
                ...
                <!-- Form -->
                <form action="{{ route('admin.interurban-company.store') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="name" value="{{ old('name') }}" required
                                        id="name" placeholder="Ex: UTB, STIF, etc.">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" id="type" required>
                                        ...
                                        <option value="SMALL">Petite (Small)</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="email" name="email" value="{{ old('email') }}"
                                        required id="email" placeholder="contact@compagnie.com">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="contact_number"
                                        value="{{ old('contact_number') }}" required id="contact_number"
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="address" required id="address" rows="3"
                                        placeholder="Adresse complète de la compagnie...">{{ old('address') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-4 bg-light border-top text-center">
                        <button type="submit" class="btn btn-submit btn-block px-5">
                            <i class="fa fa-save mr-2"></i> Enregistrer la Compagnie
                        </button>
                    </div>
                </form>
            </div>
