				...
				<form class="form-horizontal" action="{{route('admin.provider.store')}}" method="POST"
					...
					<div class="form-group row">
						<label for="password_confirmation"
							class="col-xs-12 col-form-label">@lang('admin.provides.password_confirmation')</label>
						<div class="col-xs-10">
					...
					<div class="form-group row">
						...
						<div class="col-xs-10">
							<input class="form-control" type="text" value="{{ old('commune') }}" name="commune"
					...
					<div class="form-group row">
						<label for="is_syndicated" class="col-xs-12 col-form-label">Affilié au Syndicat</label>
						<div class="col-xs-10">
							<input type="checkbox" name="is_syndicated" value="1" {{ old('is_syndicated') ? 'checked' : '' }}>
						</div>
					</div>
