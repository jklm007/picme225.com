            ...
            <div class="box box-block bg-white">
                ...
                <form class="form-horizontal" action="{{route('admin.provider.update', $provider->id)}}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            <input class="form-control" type="text" value="{{ $provider->first_name }}" name="first_name"
                    ...
                    <div class="form-group row">
                        <label for="commune" class="col-xs-2 col-form-label">Commune</label>
                        <div class="col-xs-10">
                            <input class="form-control" type="text" value="{{ $provider->commune }}" name="commune"
                                id="commune" placeholder="Ex: Cocody, Yopougon, Marcory...">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            <input class="form-control" type="number" value="{{ $provider->mobile }}" name="mobile" required
                                id="mobile" placeholder="Mobile">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="is_syndicated" class="col-xs-2 col-form-label">Affilié au Syndicat</label>
                        <div class="col-xs-10">
                            <input type="checkbox" name="is_syndicated" value="1" {{ $provider->is_syndicated ? 'checked' : '' }}>
                        </div>
                    </div>
