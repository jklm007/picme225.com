...
<div class="banner row no-margin" style="background-image: url('{{ asset('asset/img/vip_chauffeur_abidjan.png') }}'); background-size: cover; background-position: center;">
        ...
        <div class="col-md-4">
            <div class="banner-form">
                <div class="row no-margin fields">
                    ...
                    <div class="right">
                        <a href="{{ Setting::get('store_link_android_driver', 'https://play.google.com/') }}">
                            <h3>@lang('home.download_driver_app')</h3>
                ...
                <div class="row no-margin fields">
                    ...
                    <div class="right">
                        <a href="{{ Setting::get('store_link_android_driver', 'https://play.google.com/') }}">
                            <h3>@lang('home.signup_and_login')</h3>
                            <h5>@lang('home.via_driver_app') <i class="fa fa-mobile"></i></h5>
                        </a>
                    </div>
                </div>
            </div>
...
<div class="row darker-section no-margin full-section" style="background: #0D1F3C; color: #F8FAFC; padding: 60px 0;">
    <div class="container">                
        <div class="col-md-6 content-block">
            <h3 style="color: #C9A84C;">@lang('home.about_app')</h3>
            <h2 style="color: #F8FAFC;">@lang('home.about_app_heading')</h2>
            <div class="title-divider"></div>
...
<div class="footer-city row no-margin" style="background-image: url({{ asset('asset/img/vip_chauffeur_abidjan.png') }}); background-size: cover; background-position: center;"></div>
@endsection