...
<div class="pm-login-wrapper">
    ...
    <div class="pm-login-right">
        ...
        <div class="pm-social-btns">
            <a href="{{ url('/auth/facebook') }}" class="pm-social-btn">
                <i class="fa fa-facebook"></i> Facebook
            </a>
            <a href="{{ url('/auth/google') }}" class="pm-social-btn">
        ...
        <div class="pm-login-footer" id="register-link">
            ...
            <a href="{{ url('/register') }}">Créer un compte Passager</a>
        </div>
    </div>
</div>
...
<script>
    function switchRole(role) {
        ...
        if (role === 'driver') {
            ...
            forgotLink.href = '{{ url("/provider/password/reset") }}';
            registerLink.innerHTML = 'Vous souhaitez devenir chauffeur ? <a href="{{ url("/provider/register") }}">S\'inscrire comme chauffeur</a>';
        } else {
            ...
            forgotLink.href = '{{ url("/password/reset") }}';
            registerLink.innerHTML = 'Pas encore de compte ? <a href="{{ url("/register") }}">Créer un compte Passager</a>';
        }
    }
