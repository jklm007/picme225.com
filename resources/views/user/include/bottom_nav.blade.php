@if(!defined('BOTTOM_NAV_RENDERED'))
@php
...
<nav class="pm-bottom-nav" id="pm-global-bottom-nav">
    <div class="pm-nav-links">
        <a href="{{ url('home') }}" class="pm-nav-item {{ $active === 'home' ? 'active' : '' }}">
            <div class="pm-nav-icon-wrap"><i class="fa fa-home"></i></div>
            <span class="pm-nav-label">Accueil</span>
        </a>

        <a href="{{ url('trips') }}" class="pm-nav-item {{ $active === 'trips' ? 'active' : '' }}">
            <div class="pm-nav-icon-wrap"><i class="fa fa-history"></i></div>
            <span class="pm-nav-label">Trajets</span>
        </a>

        <a href="{{ url('dashboard') }}" class="pm-nav-item {{ $active === 'vtc' ? 'active' : '' }}">
            <div class="pm-nav-icon-wrap"><i class="fa {{ $active === 'vtc' ? $currentCatIcon : 'fa-taxi' }}"></i></div>
            <span class="pm-nav-label">{{ $active === 'vtc' ? $currentCatName : 'VTC' }}</span>
        </a>

        <a href="{{ route('user.marketplace.explore') }}" class="pm-nav-item {{ $active === 'store' ? 'active' : '' }}">
            <div class="pm-nav-icon-wrap"><i class="fa fa-shopping-cart"></i></div>
            <span class="pm-nav-label">Marché</span>
        </a>

        <a href="{{ url('profile') }}" class="pm-nav-item {{ $active === 'profil' ? 'active' : '' }}">
