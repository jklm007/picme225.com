				...
				<div>
		            ...
		            <br/>
		            	...
		            	<dl className="dl-horizontal left-right">
                        	...
                        	@if(isset($request->package_id) && $request->package_id != NULL)
                        	<dt>@lang('user.package')</dt>
                        	<dd>{this.props.checkState.package.kilometer}kms - {this.props.checkState.package.hour} Hrs</dd>
                        	<dt>@lang('user.rental_amount')</dt>
				...
				<div>
					...
					<div className="status">
		            	...
		            	<dl className="dl-horizontal left-right">
                        	...
                        	<dd>{this.props.checkState.package.kilometer}kms - {this.props.checkState.package.hour} Hrs</dd>
                        	<dt>@lang('user.rental_amount')</dt>
                        	<dd>{this.props.currency}{this.props.checkState.package_ren.ren_price}</dd>
                        	@else
                        	<dt>@lang('user.ride.km')</dt>
                        	<dd>{this.props.checkState.distance} kms</dd>
                        	@endif
