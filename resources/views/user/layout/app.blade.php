...
<body>
            ...
            <ul class="nav sidebar-nav">
                <li class="full-white dropdown" style="margin-top: 15px;">
                    ...
                    <ul class="dropdown-menu" style="position: relative; width: 100%; float: none; background: #070e1a; border: none; box-shadow: none; padding: 0; margin: 0;">
                        <li><a href="{{ Setting::get('store_link_android','https://play.google.com/store/apps') }}" target="_blank" style="padding: 12px 32px;"><i class="fa fa-android"></i> Google Play Store</a></li>
                        <li><a href="javascript:void(0)" onclick="installPWA('{{ Setting::get('store_link_android','#') }}')" style="padding: 12px 32px;"><i class="fa fa-download"></i> Installer l'Application</a></li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ url('/airport') }}">✈️ Navette Aéroport</a>
                </li>
                <li>
                    <a href="{{ url('/location') }}">📍 @lang('home.location')</a>
                </li>
                <li>
                    <a href="{{ url('/help') }}">💬 Aide & Contact</a>
                </li>
                <li>
                    <a href="{{ url('/privacy') }}">🛡️ Politique de confidentialité</a>
                </li>
                <li>
                ...
                <nav class="navbar navbar-fixed-top">
                    <div class="container-fluid">
                        <div class="navbar-header mobile-navbar-header">
                            ...
                            <a id="desktop-logo" class="navbar-brand pm-logo-btn" href="{{ url('/') }}">
                                <img src="{{ asset('logo.png') }}" alt="PicMe225">
                            </a>

                            {{-- Mobile Logo (Acts as Drawer Trigger, No Link) --}}
                            ...
                            <div id="pm-dl-mobile-btn" class="visible-xs">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" style="background-color: #0d1226; border: 1px solid #C9A84C;">
                                        <li><a href="{{ Setting::get('store_link_android','https://play.google.com/store/apps') }}" target="_blank" style="color: #fff; padding: 10px 20px;"><i class="fa fa-android"></i> Play Store</a></li>
                                        <li><a href="javascript:void(0)" onclick="installPWA('{{ Setting::get('store_link_android','#') }}')" style="color: #fff; padding: 10px 20px;"><i class="fa fa-download"></i> Installer l'Application</a></li>
                                    </ul>
                                </div>
                            </div>

                            {{-- Toggle collapse menu desktop --}}
                        ...
                        <div class="collapse navbar-collapse" id="pm-nav-collapse">
                            <ul class="nav navbar-nav">
                                <li @if(Request::url() == url('/')) class="active" @endif>
                                    <a href="{{url('/')}}">🏠 @lang('home.home_nav')</a>
                                </li>
                                <li @if(Request::url() == url('/marketplace')) class="active" @endif>
                                    <a href="{{url('/marketplace')}}">🛒 @lang('home.marketplace_nav')</a>
                                </li>
                                <li @if(Request::url() == url('/airport')) class="active" @endif>
                                    <a href="{{url('/airport')}}">✈️ @lang('home.airport_nav')</a>
                                </li>
                                <li @if(Request::url() == url('/location')) class="active" @endif>
                                    <a href="{{url('/location')}}">📍 @lang('home.location')</a>
                                </li>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown">
                                    <?php $current_lang = Session::get('locale') ?: (Auth::check() ? Auth::user()->language : Setting::get('language', 'fr')); ?>
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color: #fff; padding-top: 18px; font-weight: 600;">
                                        {{ strtoupper($current_lang) }} <span class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu" style="background-color: #0d1226; border: 1px solid #C9A84C; min-width: 80px;">
                                        <li><a href="javascript:void(0)" onclick="changeLanguage('fr')" style="color: #fff; padding: 10px 20px;">FR</a></li>
                                        <li><a href="javascript:void(0)" onclick="changeLanguage('en')" style="color: #fff; padding: 10px 20px;">EN</a></li>
                                    </ul>
                                </li>
                                @if(Auth::check())
                                    <li>
                                        <a href="{{ url('/dashboard') }}" style="color: #C9A84C; padding-top: 18px; font-weight: 600;">@lang('home.my_account')</a>
                                    </li>
                                @else
                                    <li>
                                        <a href="{{ url('/login') }}" style="color: #fff; padding-top: 18px; font-weight: 600;">@lang('home.login_signup')</a>
                                    </li>
                                @endif
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle pm-dl-app-btn" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="padding-top: 10px; padding-bottom: 10px; margin-top: 10px; background: linear-gradient(135deg, #0d1226, #1c264a);">
                                        📱 @lang('home.download_app_header') <span class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu" style="background-color: #0d1226; border: 1px solid #C9A84C;">
                                        <li><a href="javascript:void(0)" onclick="installPWA('{{ Setting::get('store_link_android','#') }}')" style="color: #fff; padding: 10px 20px;">📱 @lang('home.client_app')</a></li>
                                        <li><a href="{{ Setting::get('provider_store_link_android','#') }}" target="_blank" style="color: #fff; padding: 10px 20px;">🚗 @lang('home.driver_app')</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="footer row no-margin">
                    <div class="container">
                        <div class="footer-logo row no-margin">
                            <div class="logo-img">
                                <img src="{{ asset('logo.png') }}" alt="PicMe225" style="max-height: 40px;">
                            </div>
                        </div>
                        <div class="row no-margin">
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <ul>
                                    ...
                                    <li><a href="{{ url('/drive') }}">@lang('home.drive')</a></li>
                                    <li><a href="{{ url('/location') }}">@lang('home.location')</a></li>
                                    <li><a href="{{ url('/airport') }}">@lang('home.airport')</a></li>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <ul>
                                    <li><a href="{{ Setting::get('store_link_android','#') }}" target="_blank">@lang('home.sign_up_ride_sm')</a></li>
                                    <li><a href="{{url('/drive')}}">@lang('home.become_driver_sm')</a></li>
                                    <li><a href="{{ Setting::get('store_link_android','#') }}" target="_blank">@lang('home.ride_now')</a></li>                            
                                </ul>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <ul class="app">
                                    <li>
                                        <a href="javascript:void(0)" onclick="installPWA('{{ Setting::get('store_link_android','#') }}')">
                                            <img src="{{asset('asset/img/appstore.png')}}">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ Setting::get('provider_store_link_android','#') }}" target="_blank">
                        ...
                        <div class="row no-margin">
                            <div class="col-md-12 copy">
                                <p>&copy; {{ date('Y') }} PicMe225. @lang('home.all_rights_reserved') @lang('home.developed_by') <a href="https://jews-world.com" target="_blank" style="color: #C9A84C; text-decoration: none; font-weight: bold; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'">Jews-World Groupe SARL</a>.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <nav class="pm-bottom-nav">
        <div class="pm-bottom-nav-inner">
            <a href="{{url('/')}}" class="pm-bottom-nav-item {{ Request::url() == url('/') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg>
                <span>@lang('home.bottom_nav_home')</span>
            </a>
            <a href="{{url('/drive')}}" class="pm-bottom-nav-item {{ Request::url() == url('/drive') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24"><path d="M18.92 6.01C18.72 5.42 18.16 5 17.5 5h-11c-.66 0-1.21.42-1.42 1.01L3 12v8c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-1h12v1c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-8l-2.08-5.99zM6.5 16c-.83 0-1.5-.67-1.5-1.5S5.67 13 6.5 13s1.5.67 1.5 1.5S7.33 16 6.5 16zm11 0c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM5 11l1.5-4.5h11L19 11H5z"/></svg>
                <span>@lang('home.bottom_nav_vtc')</span>
            </a>
            <a href="{{url('/marketplace')}}" class="pm-bottom-nav-item {{ Request::url() == url('/marketplace') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24"><path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.08-.14.12-.31.12-.48 0-.55-.45-1-1-1H5.21l-.94-2H1zm16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"/></svg>
                <span>@lang('home.bottom_nav_market')</span>
            </a>
            <a href="{{url('/login')}}" class="pm-bottom-nav-item">
                <svg viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
                <span>@lang('home.bottom_nav_account')</span>
            </a>
        </div>
    </nav>
