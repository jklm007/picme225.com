...
@section('header-sub', 'Paramètres de votre compte')
...
<div class="profile-page">
    ...
    <div class="profile-hero">
        <div class="profile-avatar-wrap">
            @if(Auth::user()->picture)
                <div class="profile-avatar" style="background-image:url('{{ img(Auth::user()->picture) }}')"></div>
            @else
                <div class="profile-avatar">{{ strtoupper(substr(Auth::user()->first_name,0,1)) }}</div>
            @endif
            <a href="{{ url('edit/profile') }}" class="profile-avatar-edit"><i class="fa fa-pencil"></i></a>
        </div>
        ...
        <div>
            <a href="{{ url('edit/profile') }}" class="profile-edit-btn">
        ...
        <div class="profile-stats">
            <div class="profile-stat-item">
                <div class="profile-stat-num">{{ currency(Auth::user()->wallet_balance) }}</div>
                <div class="profile-stat-lbl">Wallet</div>
            </div>
            <div class="profile-stat-item">
                <div class="profile-stat-num">{{ Auth::user()->eco_token_balance ?? '0' }}</div>
    ...
    <div class="profile-cards">
        ...
        <div class="profile-card">
            ...
            <div class="profile-row">
                ...
                <div class="profile-row-body">
                    ...
                    <div class="profile-row-val">{{ Auth::user()->first_name }}</div>
                </div>
            </div>
            <div class="profile-row">
                <div class="profile-row-icon"><i class="fa fa-id-card-o"></i></div>
                <div class="profile-row-body">
                    ...
                    <div class="profile-row-val">{{ Auth::user()->last_name }}</div>
                </div>
            </div>
            <div class="profile-row">
                ...
                <div class="profile-row-body">
                    ...
                    <div class="profile-row-val">{{ Auth::user()->email }}</div>
                </div>
            </div>
            <div class="profile-row">
                ...
                <div class="profile-row-body">
                    ...
                    <div class="profile-row-val">{{ Auth::user()->mobile ?? '–' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="profile-card">
            ...
            <a href="{{ url('wallet') }}" class="profile-row">
                ...
                <div class="profile-row-body">
                    ...
                    <div class="profile-eco-val">{{ Auth::user()->eco_token_balance ?? '0' }}</div>
                </div>
                <div class="profile-row-action"><i class="fa fa-chevron-right"></i></div>
            </a>
            <a href="{{ url('payment') }}" class="profile-row">
        ...
        <div class="profile-card">
            ...
            <a href="{{ url('trips') }}" class="profile-row">
            ...
            <a href="{{ url('upcoming/trips') }}" class="profile-row">
        ...
        <div class="profile-card">
            ...
            <div class="profile-row">
                ...
                <div class="profile-row-body">
                    ...
                    <div class="profile-row-val">{{ Auth::user()->language == 'fr' ? '🇫🇷 Français' : '🇬🇧 English' }}</div>
                </div>
            </div>
            <a href="{{ url('promotions') }}" class="profile-row">
        ...
        <div class="profile-card">
            ...
            <a href="{{ url('change/password') }}" class="profile-row">
        ...
        {{-- Déconnexion --}}
        <form action="{{ url('/logout') }}" method="POST" id="profile-logout-form">
            {{ csrf_field() }}
        </form>
