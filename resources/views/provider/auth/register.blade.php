...
<div class="col-md-12">
    <form class="form-horizontal" role="form" method="POST" action="{{ url('/provider/register') }}" enctype="multipart/form-data">
        ...
        <div id="second_step" style="display: none;">
            ...
            <select class="form-control" name="service_type" id="service_type" class="service_type">
                <option value="">Select Service</option>
                @foreach(get_all_service_types()->where('ambulance','!=','1') as $type)
            ...
            <select class="form-control" name="hospital_id" id="hospital" style="display:none;">
