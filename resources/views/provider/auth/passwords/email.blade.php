...
<div class="pm-login-wrapper">
    ...
    <div class="pm-login-right">
        ...
        <!-- FORM -->
        <form role="form" method="POST" action="{{ url('/provider/password/reset/otp') }}">
            {{ csrf_field() }}
        ...
        <div class="pm-login-footer">
            DÃ©jÃ  un compte ?
            <a href="{{ url('/provider/login') }}">Connexion</a><br><br>
            Vous souhaitez devenir passager ? <a href="{{ url('/register') }}">S'inscrire</a>
        </div>
    </div>
</div>
