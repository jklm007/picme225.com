                                    ...
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-right-padding">
                                        <div class="form-group no-margin">
                                            ...
                                            <select class="form-control" name="language">
                                                <option <?php if(Auth::guard('provider')->user()->language=='en') { echo 'selected=selected'; } ?> value="en">English</option>
                                                <option <?php if(Auth::guard('provider')->user()->language=='fr') { echo 'selected=selected'; } ?> value="fr">French</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-right-padding">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="country">
                                                ...
                                                <option value="AF">West Africa</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
