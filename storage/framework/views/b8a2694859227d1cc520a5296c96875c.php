...
<?php $__env->startSection('title', 'Dashboard – PicMe225'); ?>
...
<div id="pm-wrapper">
    ...
    <div class="pm-sheet" id="pm-sheet">
        ...
        <form action="<?php echo e(url('confirm/ride')); ?>" method="GET" id="booking-form" onkeypress="return event.key!='Enter'">
            ...
            <div class="pm-user-stats-compact" style="display: flex; gap: 10px; margin: 0 16px 10px 16px; align-items: center;">
                <div style="background: rgba(13,27,42,0.05); padding: 4px 10px; border-radius: 20px; font-size: 11px; font-weight: 700; color: var(--navy); display: flex; align-items: center; gap: 4px;">
                    ...
                    <?php echo e(Auth::user()->rating ?? '5.0'); ?>
                ...
                <div style="background: rgba(34,197,94,0.1); padding: 4px 10px; border-radius: 20px; font-size: 11px; font-weight: 700; color: var(--lime-dark); display: flex; align-items: center; gap: 4px;">
                    ...
                    <?php echo e(Auth::user()->user_badge ?? 'Explorateur'); ?>
                ...
                <div class="pm-ads-scroll">
                    <a href="<?php echo e(route('user.marketplace.explore')); ?>" class="pm-ad-banner">
                        <div class="pm-ad-content">
                            ...
                            <h3 class="pm-ad-title">PicMe225 Store</h3>
                            <p class="pm-ad-desc">Achetez et vendez facilement en ligne avec livraison.</p>
                        </div>
                    </a>
                    <a href="<?php echo e(route('user.marketplace.explore')); ?>" class="pm-ad-banner">
                        <div class="pm-ad-content">
            ...
            <div class="pm-tabs" role="tablist">
                ...
                <button type="button" class="pm-tab <?php echo e($loop->first ? 'active' : ''); ?>"
                        onclick="pmSwitchTab(<?php echo e($category->id); ?>)"
                        id="pm-tab-<?php echo e($category->id); ?>" role="tab">
                    <div class="pm-tab-label"><?php echo e($category->name); ?></div>
            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div id="pm-pane-<?php echo e($category->id); ?>" class="pm-pane <?php echo e($loop->first ? 'active' : ''); ?>" style="display:<?php echo e($loop->first ? 'contents' : 'none'); ?>">

                    
                    <div class="pm-pills" id="pills-<?php echo e($category->id); ?>">
                        <label class="pm-pill active" onclick="pmSetVariant(<?php echo e($category->id); ?>,'prive',this)">
                            <input type="radio" name="var_<?php echo e($category->id); ?>" value="prive" checked> 🚗 Privé
                        </label>
                        <label class="pm-pill" onclick="pmSetVariant(<?php echo e($category->id); ?>,'partage',this)">
                            <input type="radio" name="var_<?php echo e($category->id); ?>" value="partage"> 👥 Partage
                        </label>
                        <label class="pm-pill" onclick="pmSetVariant(<?php echo e($category->id); ?>,'arret_pdp',this)">
                            <input type="radio" name="var_<?php echo e($category->id); ?>" value="arret_pdp"> 🚌 Gare-à-Gare
                        </label>
                    </div>

                    
                    <?php if(strtolower($category->name) == 'location'): ?>
                        <div class="pm-autocomplete-wrap">
                            <div class="pm-input-wrap">
                                ...
                                <input type="text" class="pm-input pm-autocomplete-input"
                                    id="rental_location_<?php echo e($category->id); ?>" name="rental_location"
                                    placeholder="Adresse de prise en charge"
                                    autocomplete="off"
                                    data-target="origin">
                            </div>
                            <div class="pm-autocomplete-list" id="ac-rental-<?php echo e($category->id); ?>"></div>
                        </div>
                        <div class="pm-input-wrap">
                            ...
                            <select class="pm-input" name="package_id" style="padding-left:42px">
                                ...
                                <?php $__currentLoopData = $package; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($p->id); ?>"><?php echo e($p->kilometer); ?> Km — <?php echo e($p->hour); ?>H</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>

                    <?php elseif(strtolower($category->name) == 'voyage' || strtolower($category->name) == 'outstation'): ?>
                        <div class="pm-connector">
                            <div class="pm-autocomplete-wrap">
                                <div class="pm-input-wrap">
                                    <i class="fa fa-dot-circle-o icon icon-origin"></i>
                                    <input type="text" class="pm-input pm-autocomplete-input"
                                        id="o_trip_tab_<?php echo e($category->id); ?>" name="o_trip_tab"
                                        placeholder="Ville de départ" autocomplete="off"
                                        data-target="origin" data-cat="<?php echo e($category->id); ?>">
                                </div>
                                <div class="pm-autocomplete-list" id="ac-o-<?php echo e($category->id); ?>"></div>
                            </div>
                            ...
                            <div class="pm-autocomplete-wrap">
                                <div class="pm-input-wrap">
                                    ...
                                    <input type="text" class="pm-input pm-autocomplete-input"
                                        id="d_trip_tab_<?php echo e($category->id); ?>" name="d_trip_tab"
                                        placeholder="Ville de destination" autocomplete="off"
                                        data-target="destination" data-cat="<?php echo e($category->id); ?>">
                                </div>
                                <div class="pm-autocomplete-list" id="ac-d-<?php echo e($category->id); ?>"></div>
                            </div>
                        </div>
                        ...
                        <div class="pm-connector" style="position:relative">
                            <div class="pm-autocomplete-wrap">
                                <div class="pm-input-wrap">
                                    <i class="fa fa-dot-circle-o icon icon-origin"></i>
                                    <input type="text" class="pm-input pm-autocomplete-input"
                                        id="origin-input-<?php echo e($category->id); ?>" name="s_address"
                                        placeholder="Point de départ" autocomplete="off"
                                        data-target="origin" data-cat="<?php echo e($category->id); ?>">
                                </div>
                                <div class="pm-autocomplete-list" id="ac-origin-<?php echo e($category->id); ?>"></div>
                            </div>
                            <div class="pm-dash"></div>
                            <div class="pm-autocomplete-wrap">
                                <div class="pm-input-wrap">
                                    <i class="fa fa-map-marker icon icon-dest"></i>
                                    <input type="text" class="pm-input pm-autocomplete-input"
                                        id="dest-input-<?php echo e($category->id); ?>" name="d_address"
                                        placeholder="Où allez-vous ?" autocomplete="off"
                                        data-target="destination" data-cat="<?php echo e($category->id); ?>">
                                </div>
                                <div class="pm-autocomplete-list" id="ac-dest-<?php echo e($category->id); ?>"></div>
                            </div>
                            
                            <button type="button" class="pm-swap-btn"
                                style="position:absolute;right:12px;top:50%;transform:translateY(-50%)"
                                onclick="pmSwapAddresses(<?php echo e($category->id); ?>)">
                    ...
                    <div class="pm-estimate" id="estimate-<?php echo e($category->id); ?>">
                        <div class="pm-estimate-block">
                            <div class="pm-estimate-label">Distance</div>
                            <div class="pm-estimate-val" id="est-dist-<?php echo e($category->id); ?>">—</div>
                        </div>
                        <div class="pm-estimate-block">
                            <div class="pm-estimate-label">Durée</div>
                            <div class="pm-estimate-val" id="est-dur-<?php echo e($category->id); ?>">—</div>
                        </div>
                        <div class="pm-estimate-block">
                            <div class="pm-estimate-label">Prix estimé</div>
                            <div class="pm-estimate-val" id="est-price-<?php echo e($category->id); ?>">—</div>
                        </div>
                    </div>

                    
                    <div class="pm-vehicles" id="grid-<?php echo e($category->id); ?>">
                        <?php $__currentLoopData = $category->serviceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $variants = is_array($service->allowed_variants)
                                    ? $service->allowed_variants
                                    : json_decode($service->allowed_variants, true) ?? [];
                            ?>
                            <label class="pm-vcard variant-card <?php echo e($loop->first ? 'active' : ''); ?>"
                                   data-variants="<?php echo e(json_encode($variants)); ?>"
                                   for="svc_<?php echo e($service->id); ?>">
                                <?php if($loop->first): ?>
                                    <span class="pm-vcard-badge">⭐ Populaire</span>
                                <?php endif; ?>
                                <input type="radio" name="service_type" value="<?php echo e($service->id); ?>"
                                       id="svc_<?php echo e($service->id); ?>"
                                       <?php echo e($loop->first ? 'checked' : ''); ?>

                                       onchange="pmSelectVehicle(this)">
                                <img class="pm-vcard-img" src="<?php echo e($service->image_url); ?>" alt="<?php echo e($service->name); ?>">
                                <div class="pm-vcard-name"><?php echo e($service->name); ?></div>
                                <div class="pm-vcard-seats"><i class="fa fa-user"></i> 1–<?php echo e($service->capacity); ?></div>
                                <div class="pm-vcard-price"><?php echo e(currency($service->price)); ?></div>
                                <div class="pm-vcard-eta"><i class="fa fa-clock-o"></i> ~<?php echo e(rand(3,8)); ?> min</div>
                            </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if($category->serviceTypes->isEmpty()): ?>
...
var PHOTON_URL = '<?php echo e(env("PHOTON_URL", "https://photon.komoot.io")); ?>';
...
window.addEventListener('load', function() {
    ...
    <?php $cid = $category->id; ?>
    <?php if(strtolower($category->name) == 'location'): ?>
        pmAutocomplete('rental_location_<?php echo e($cid); ?>', 'ac-rental-<?php echo e($cid); ?>', 'origin', <?php echo e($cid); ?>);
    <?php elseif(strtolower($category->name) == 'voyage' || strtolower($category->name) == 'outstation'): ?>
        pmAutocomplete('o_trip_tab_<?php echo e($cid); ?>', 'ac-o-<?php echo e($cid); ?>', 'origin',      <?php echo e($cid); ?>);
        pmAutocomplete('d_trip_tab_<?php echo e($cid); ?>', 'ac-d-<?php echo e($cid); ?>', 'destination', <?php echo e($cid); ?>);
    <?php else: ?>
        pmAutocomplete('origin-input-<?php echo e($cid); ?>', 'ac-origin-<?php echo e($cid); ?>', 'origin',      <?php echo e($cid); ?>);
        pmAutocomplete('dest-input-<?php echo e($cid); ?>',   'ac-dest-<?php echo e($cid); ?>',   'destination', <?php echo e($cid); ?>);
    <?php endif; ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

    // Init first tab variant filter
    <?php if($categories->isNotEmpty()): ?>
    pmSetVariant(<?php echo e($categories->first()->id); ?>, 'prive',
        document.querySelector('#pills-<?php echo e($categories->first()->id); ?> .pm-pill'));
    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layout.user_dashboard', ['active' => 'vtc'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Documents\Jews-world Backend\picme225.com_backend\resources\views/user/dashboard.blade.php ENDPATH**/ ?>