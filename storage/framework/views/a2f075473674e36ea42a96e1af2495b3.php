...
<div class="pm-login-wrapper">
    ...
    <div class="pm-login-right">
        ...
        <div class="pm-login-footer">
            Déjà un compte ?
            <a href="<?php echo e(url('/login')); ?>">Se connecter</a><br><br>
            Vous souhaitez devenir chauffeur ? <a href="<?php echo e(url('/drive')); ?>">En savoir plus</a>
        </div>
    </div>
</div>
...
<?php echo $__env->make('user.layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/user/auth/register.blade.php ENDPATH**/ ?>