...
<div class="pm-login-wrapper">
    ...
    <div class="pm-login-left">
        ...
        <div class="pm-login-tagline">
            <h1>CrÃ©ez votre compte <span>PicMe225</span></h1>
            <p>Rejoignez la plateforme de mobilitÃ© numÃ©ro 1 en CÃ´te d'Ivoire. Rapide, sÃ©curisÃ© et pensÃ© pour vous.</p>
        </div>

        <div class="pm-login-features">
            <div class="pm-feature-item">
                <div class="pm-feature-icon"><i class="fa fa-car"></i></div>
                <span>Commandez des courses instantanÃ©ment</span>
            </div>
            <div class="pm-feature-item">
            ...
            <div class="pm-feature-item">
                ...
                <span>Paiement Mobile Money sÃ©curisÃ©</span>
            </div>
        </div>
    </div>
    ...
    <div class="pm-login-right">
        <div class="pm-login-header">
            ...
            <p>VÃ©rifiez votre numÃ©ro pour commencer</p>
        </div>
            ...
            <div id="first_step">
                <div class="pm-form-row">
                    ...
                    <div class="pm-form-group" style="flex: 1;">
                        ...
                        <input type="text" id="phone_number" name="phone_number" value="<?php echo e(old('phone_number')); ?>" placeholder="0102030405" required autofocus>
                    </div>
                </div>
            ...
            <div id="second_step">
                <div class="pm-form-row">
                    <div class="pm-form-group">
                        <label>PrÃ©nom</label>
                        <input type="text" name="first_name" value="<?php echo e(old('first_name')); ?>" placeholder="Jean" required>
                    </div>
                    <div class="pm-form-group">
                        <label>Nom</label>
                        <input type="text" name="last_name" value="<?php echo e(old('last_name')); ?>" placeholder="Kouadio" required>
                    </div>
                </div>

                <div class="pm-form-group">
                    <label>Adresse E-mail</label>
                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="jean.kouadio@email.com" required>
                </div>
                ...
                <button type="submit" class="pm-btn-login">
                    <i class="fa fa-check-circle"></i> CrÃ©er mon compte
                </button>
            </div>
        </form>
        ...
        <div class="pm-login-footer">
            DÃ©jÃ  un compte ?
            <a href="<?php echo e(url('/provider/login')); ?>">Se connecter</a><br><br>
            Vous souhaitez créer un compte passager ? <a href="<?php echo e(url('/register')); ?>">S'inscrire</a>
        </div>
    </div>
</div>
  ...
  function onSignInSubmit() {
    ...
    firebase.auth().signInWithPhoneNumber(fullPhoneNumber, appVerifier)
      .then(function(confirmationResult) {
        ...
        var code = window.prompt("Entrez le code de vÃ©rification reÃ§u par SMS :");
        return confirmationResult.confirm(code);
      })
      .then(function(result) {
        var msg = document.getElementById('mobile_verfication');
        msg.innerHTML = '<i class="fa fa-check"></i> NumÃ©ro vÃ©rifiÃ© avec succÃ¨s !';
...
<?php echo $__env->make('user.layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/provider/auth/register.blade.php ENDPATH**/ ?>