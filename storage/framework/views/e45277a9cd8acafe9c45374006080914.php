    ...
    <div class="pm-mkt-header" style="background: linear-gradient(135deg, var(--lime, #22C55E), var(--lime-dark, #15803D)); padding: 90px 16px 24px 16px; border-bottom: 1px solid rgba(0,0,0,0.08); display: flex; flex-direction: column; gap: 16px;">
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px;">
            ...
            <div style="display: flex; gap: 8px;">
                <a href="<?php echo e(route('user.marketplace.my')); ?>" class="btn" style="padding: 8px 16px; background: rgba(255,255,255,0.2); backdrop-filter: blur(4px); color: #ffffff; border-radius: 20px; border: 1px solid rgba(255,255,255,0.3); font-size: 12px; font-weight: 800; text-decoration: none; display: flex; align-items: center; gap: 6px;">
                    <i class="fa fa-list"></i> Mes Annonces
                </a>
                <a href="<?php echo e(route('user.marketplace.create')); ?>" class="btn" style="padding: 8px 16px; background: #ffffff; color: var(--lime-dark, #15803D); border-radius: 20px; font-size: 12px; font-weight: 800; text-decoration: none; display: flex; align-items: center; gap: 6px; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
...
<div class="pm-app-modal" id="pm-app-modal">
    ...
    <section class="pm-mkt-filters">
        <div class="container">
            <form action="<?php echo e(route('user.marketplace.explore')); ?>" method="GET" id="pm-filter-form">
...
<?php echo $__env->make('user.layout.user_dashboard', ['active' => 'store'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Documents\Jews-world Backend\picme225.com_backend\resources\views/user/marketplace/explore.blade.php ENDPATH**/ ?>