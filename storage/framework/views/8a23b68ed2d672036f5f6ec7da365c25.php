...
<div class="pm-login-wrapper">
    ...
    <div class="pm-login-right">
        ...
        <!-- FORM -->
        <form role="form" method="POST" action="<?php echo e(url('/provider/password/reset/otp')); ?>">
        ...
        <div class="pm-login-footer">
            DÃ©jÃ  un compte ?
            <a href="<?php echo e(url('/provider/login')); ?>">Connexion</a><br><br>
            Vous souhaitez devenir passager ? <a href="<?php echo e(url('/register')); ?>">S'inscrire</a>
        </div>
    </div>
</div>
...
<?php echo $__env->make('user.layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/provider/auth/passwords/email.blade.php ENDPATH**/ ?>