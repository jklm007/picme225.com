...
<div class="pm-login-wrapper">
    ...
    <div class="pm-login-left">
        <a href="<?php echo e(url('/login')); ?>" class="pm-back-btn">
    ...
    <div class="pm-login-right">
        ...
        <div class="pm-alert pm-alert-error">
            <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div><i class="fa fa-exclamation-circle"></i> <?php echo e($error); ?></div>
        ...
        <div class="pm-step active" id="step-email">
            <form method="POST" action="<?php echo e(url('/password/email')); ?>">
                ...
                <div class="pm-form-group">
                    ...
                    <input type="email" name="email" placeholder="votre@email.com" value="<?php echo e(old('email')); ?>" required autofocus>
                </div>
        ...
        <div class="pm-step" id="step-sms">
            ...
            <div class="pm-step" id="sms-step-3">
                ...
                <form method="POST" action="<?php echo e(url('/password/reset/otp')); ?>" id="reset-password-form">
                    <?php echo e(csrf_field()); ?>
        ...
        <div class="pm-login-footer">
            Retour à la <a href="<?php echo e(url('/login')); ?>">connexion</a>
        </div>
    </div>
</div>
...
<?php echo $__env->make('user.layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/user/auth/passwords/email.blade.php ENDPATH**/ ?>