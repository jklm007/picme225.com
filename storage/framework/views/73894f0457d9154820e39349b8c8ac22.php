...
<div class="pm-app-modal" id="pm-app-modal">
    <div class="pm-modal-box">
        ...
        <div class="pm-qr-box">
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=130x130&data=<?php echo e(urlencode(Setting::get('store_link_android','https://play.google.com'))); ?>" alt="QR App" />
        </div>
        ...
        <div class="pm-modal-dl-btns">
            <a href="<?php echo e(Setting::get('store_link_android','https://play.google.com/store/apps')); ?>" target="_blank" class="pm-modal-btn pm-modal-btn-play">
                <i class="fa fa-android" style="font-size:20px"></i> Google Play Store
            </a>
            <a href="javascript:void(0)" onclick="installPWA('<?php echo e(Setting::get('store_link_android','#')); ?>')" class="pm-modal-btn pm-modal-btn-apk">
...
<div class="container">
    ...
    <nav class="pm-breadcrumb">
        ...
        <span>›</span>
        <span><?php echo e($listing->category ?? 'Annonce'); ?></span>
        <span>›</span>
        <span style="color:#e2e8f0;"><?php echo e(\Illuminate\Support\Str::limit($listing->title, 40)); ?></span>
    </nav>
    ...
    <div class="row mt-4" style="gap:0;">
        ...
        <div class="col-lg-7">
            <div class="pm-gallery">
                <?php
                    ...
                    $imgUrlFn = function($src) {
                        if (!$src) return null;
                        if (str_starts_with($src, 'data:') || str_starts_with($src, 'http')) return $src;
                        return url('storage/' . $src);
                    };
                ...
                <div class="pm-gallery-main" id="pm-main-img-wrap" onclick="openLightbox(0)">
                    <?php if($firstImg): ?>
                        <img id="pm-main-img" src="<?php echo e($imgUrlFn($firstImg)); ?>" alt="<?php echo e($listing->title); ?>" />
                    <?php else: ?>
                        <div class="pm-no-img"><?php echo e($catEmojiFn($listing->category)); ?></div>
                    <?php endif; ?>
                    <?php if(count($allImages) > 1): ?>
                    <div class="pm-photo-count">
                        <i class="fa fa-camera"></i> <?php echo e(count($allImages)); ?> photos
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="pm-gallery-thumbs" id="pm-thumbs">
                    ...
                    <div class="pm-thumb <?php echo e($idx === 0 ? 'active' : ''); ?>" onclick="setMainImg(<?php echo e($idx); ?>)" data-idx="<?php echo e($idx); ?>">
                        <img src="<?php echo e($imgUrlFn($img)); ?>" alt="Photo <?php echo e($idx + 1); ?>" loading="lazy" />
                    </div>
            ...
            <div class="pm-info-panel d-none d-lg-block mt-3">
                ...
                <div class="pm-desc"><?php echo e($listing->description); ?></div>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="col-lg-5 ps-lg-4 mt-4 mt-lg-0">
            <div class="pm-info-panel">
                ...
                <div class="pm-badge"><?php echo e($listing->category ?? 'Annonce'); ?><?php echo e($listing->sub_category ? ' · ' . $listing->sub_category : ''); ?></div>
                <?php if($listing->type === 'SEARCH'): ?>
                ...
                <div class="pm-detail-title"><?php echo e($listing->title); ?></div>

                <div class="pm-detail-price">
                    <?php echo e(number_format($listing->price, 0, ',', ' ')); ?>

                    <small><?php echo e($listing->price_unit ?? 'FCFA'); ?></small>
                </div>

                <ul class="pm-meta-list">
                    <?php if($listing->location_city || true): ?>
                    <?php
                    ...
                    <li>
                        ...
                        <span><strong>Lieu</strong> &nbsp;<span class="pm-meta-value"><?php echo e($loc); ?></span></span>
                    </li>
                    <?php endif; ?>
                    <?php if($listing->brand): ?>
                    <li>
                        <div class="pm-meta-icon"><i class="fa fa-tag"></i></div>
                        <span><strong>Marque</strong> &nbsp;<span class="pm-meta-value"><?php echo e($listing->brand); ?></span></span>
                    </li>
                    <?php endif; ?>
                    <?php if($listing->model ?? ($listing->metadata['model'] ?? null)): ?>
                    <li>
                        <div class="pm-meta-icon"><i class="fa fa-car"></i></div>
                        <span><strong>Modèle</strong> &nbsp;<span class="pm-meta-value"><?php echo e($listing->model ?? ($listing->metadata['model'] ?? '')); ?></span></span>
                    </li>
                    <?php endif; ?>
                    <?php if($listing->year ?? ($listing->metadata['year'] ?? null)): ?>
                    <li>
                        <div class="pm-meta-icon"><i class="fa fa-calendar"></i></div>
                        <span><strong>Année</strong> &nbsp;<span class="pm-meta-value"><?php echo e($listing->year ?? ($listing->metadata['year'] ?? '')); ?></span></span>
                    </li>
                    <?php endif; ?>
                    <?php if(isset($listing->metadata['condition']) || isset($listing->metadata['etat'])): ?>
                    <li>
                        <div class="pm-meta-icon"><i class="fa fa-star"></i></div>
                        <span><strong>État</strong> &nbsp;<span class="pm-meta-value"><?php echo e($listing->metadata['condition'] ?? ($listing->metadata['etat'] ?? 'Non spécifié')); ?></span></span>
                    </li>
                    <?php endif; ?>
                    <li>
                        <div class="pm-meta-icon"><i class="fa fa-user"></i></div>
                        <span><strong>Vendeur</strong> &nbsp;<span class="pm-meta-value"><?php echo e($listing->owner_name ?? ($listing->user ? $listing->user->first_name . ' ' . $listing->user->last_name : 'Particulier')); ?></span></span>
                    </li>
                    <li>
                        <div class="pm-meta-icon"><i class="fa fa-clock-o"></i></div>
                        <span><strong>Publié</strong> &nbsp;<span class="pm-meta-value"><?php echo e($listing->created_at->diffForHumans()); ?></span></span>
                    </li>
                </ul>
                ...
                ?>
                <a href="https://wa.me/<?php echo e($cleanPhone); ?>?text=<?php echo e(urlencode('Bonjour, je suis intéressé(e) par l\'annonce : ' . $listing->title . ' — ' . url('/marketplace/' . $listing->id))); ?>" class="pm-cta-whatsapp" target="_blank">
                ...
                <div style="display: flex; gap: 12px; margin-bottom: 20px; align-items: center; flex-wrap: wrap;">
                    ...
                    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(url('/marketplace/' . $listing->id))); ?>" target="_blank" class="pm-share-btn pm-share-fb" title="Partager sur Facebook">
                    ...
                    <a href="https://api.whatsapp.com/send?text=<?php echo e(urlencode($listing->title . ' — ' . url('/marketplace/' . $listing->id))); ?>" target="_blank" class="pm-share-btn pm-share-wa" title="Partager sur WhatsApp">
    ...
    <div class="pm-related">
        ...
        <div class="pm-related-grid">
            ...
            ?>
            <a href="/marketplace/<?php echo e($rel->id); ?>" class="pm-rel-card">
                <?php if($relUrl): ?>
                    <img src="<?php echo e($relUrl); ?>" alt="<?php echo e($rel->title); ?>" loading="lazy" onerror="this.parentElement.innerHTML='<div class=\'pm-rel-no-img\'>📦</div>'" />
                <?php else: ?>
                    <div class="pm-rel-no-img"><?php echo e($catEmojiFn($rel->category)); ?></div>
                <?php endif; ?>
                <div class="pm-rel-body">
                    <div class="pm-rel-title"><?php echo e($rel->title); ?></div>
                    <div class="pm-rel-price"><?php echo e(number_format($rel->price, 0, ',', ' ')); ?> FCFA</div>
                </div>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
var pmImages = [
    ...
    <?php $pmImgUrl = str_starts_with($img,'data:')||str_starts_with($img,'http') ? $img : url('storage/'.$img); ?>
    "<?php echo e(addslashes($pmImgUrl)); ?>",
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
];
var pmCurrent = 0;
...
<?php echo $__env->make('user.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/marketplace/detail.blade.php ENDPATH**/ ?>