<?php $__env->startSection('title', 'Mes Trajets'); ?>
<?php $__env->startSection('header-sub', 'Historique de vos trajets'); ?>
<?php $bottomNavActive = 'trips'; ?>
...
<div class="trips-page">
    ...
    <div class="trips-hero">
        ...
        <div class="trips-stats-row">
            <div class="trips-stat-pill">
                <div class="num"><?php echo e(method_exists($trips, 'total') ? $trips->total() : count($trips)); ?></div>
                <div class="lbl">Trajets totaux</div>
            </div>
            <div class="trips-stat-pill">
                <div class="num"><?php echo e(currency(Auth::user()->wallet_balance)); ?></div>
    ...
    <div class="trips-list">
        ...
        <?php if((method_exists($trips,'count') ? $trips->count() : count($trips)) > 0): ?>
            ...
            <div class="trip-card" style="animation-delay: <?php echo e($index * 0.05); ?>s;">
                <div class="trip-card-header">
                    <div class="trip-card-icon">
                        <?php if($trip->service_type): ?>
                            <img src="<?php echo e($trip->service_type->image ?? ''); ?>" alt="" style="width:28px;height:28px;object-fit:contain;" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
                    ...
                    <div class="trip-card-meta">
                        <div class="trip-card-service">
                            <?php echo e($trip->service_type ? $trip->service_type->name : 'Course'); ?>

                            <?php if($trip->booking_id): ?>
                                <span style="font-size:11px;color:#94A3B8;font-weight:400;"> — <?php echo e($trip->booking_id); ?></span>
                            <?php endif; ?>
                        </div>
                        <div class="trip-card-date">
                            <i class="fa fa-clock-o" style="margin-right:4px;"></i>
                            <?php if($trip->assigned_at): ?>
                                <?php echo e(\Carbon\Carbon::parse($trip->assigned_at)->format('d/m/Y à H\hi')); ?>
                ...
                <div class="trip-card-body">
                    <div class="trip-route">
                        <div class="trip-route-item">
                            ...
                            <span class="trip-route-address"><?php echo e($trip->s_address ?? 'Départ inconnu'); ?></span>
                        </div>
                        <div class="trip-route-item">
                            <span class="trip-route-dot to"></span>
                            <span class="trip-route-address"><?php echo e($trip->d_address ?? 'Destination inconnue'); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="trip-card-footer">
                    ...
                    <?php if($trip->payment_mode): ?>
                    <span class="trip-badge payment">
                        <i class="fa fa-credit-card"></i> <?php echo e($trip->payment_mode); ?>

                    </span>
                    <?php endif; ?>
                    <?php if($trip->provider): ?>
                    <span class="trip-badge provider">
                        <i class="fa fa-user"></i> <?php echo e($trip->provider->first_name); ?> <?php echo e($trip->provider->last_name); ?>
            ...
            <?php if(method_exists($trips, 'links')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layout.user_dashboard', ['active' => 'trips'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Documents\Jews-world Backend\picme225.com_backend\resources\views/user/ride/trips.blade.php ENDPATH**/ ?>