    ...
    render() {
        return (
            <div>
                ...
                <div id="cancel-reason1" className="modal fade" role="dialog">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <button type="button" className="close" data-dismiss="modal">&times;</button>
               ...
               <button type="button" className="full-primary-btn fare-btn reg-btn" data-toggle="modal" data-target="#cancel-reason1">Cancel</button>
            </div>
        );
    }
}
