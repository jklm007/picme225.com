...
{
    /**
     * Get the current precalculated heatmap (Predicted Demand Score) for Provider App
     * GET /provider/heatmap/current
     */
    public function current(Request $request)
    {
        ...
        foreach ($zones as $zone) {
            ...
            // Seules les zones avec une forte demande (> 50) sont pertinentes pour les chauffeurs
            if ($pds > 50) {
                $heatmap[] = [
                    'geohash' => $zone,
                    'pds'     => $pds
